...
const MagicButton = ({
  ...
  return (
    ...
    >
      <span
        className="absolute inset-0 before:absolute before:inset-0 before:-z-10 before:animate-pulse before:bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]"
      />
      <span
